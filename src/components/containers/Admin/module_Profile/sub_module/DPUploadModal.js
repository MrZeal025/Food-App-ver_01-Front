...
export class DPUploadModal extends Component {
    ...
    async componentDidMount() {
        ...
        const profile = await axios.get(`/api/admin/profile/read/${decode._id}`, config);
        this.setState({
    ...
    uploadProfile = async () => {
        ...
        try {
            const upload =  await axios.put(`/api/uploads/admin/profile/${_id}`, formData, config);
            this.setState({
                showDPModal: false,
                profilePicture: upload.data.data.admin
            })
